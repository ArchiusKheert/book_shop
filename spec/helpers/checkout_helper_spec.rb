...
RSpec.describe CheckoutController, type: :controller do
  ...
  describe 'GET #show' do
    ...
    describe 'addresses step' do
      ...
      it 'render addresses template' do
  ...
  describe 'PUT #update' do
    ...
    describe 'addresses' do
      before do
        allow(AddressesForm).to receive(:new) {FactoryBot.build(:address)}
    ...
    describe 'confirm' do
      ...
      %i[order_id cart].each do |par|
        it "clear #{par} from session" do
          expect(session[par]).to be_nil
        end
      end
    end
